...
public class GssSample : MonoBehaviour
{
    ...
    [SerializeField]
    public GssDbHub        _gssDbHub        = null;
    [SerializeField]
    public AreaDataManager _areaDataManager = null;
    ...
    void Start()
    {
        ...
        if (_areaDataManager==null){
            _areaDataManager = GetComponent<AreaDataManager>();
        }
        if (_gssDbHub ==null){
    ...
    void Update()
    {
        ...
        if (CanGetNewPos(newPos))
        {
            ...
            if (isClosed)
            {
                ...
                _areaDataManager.UpdateCurrentAreaDatas(_userName,tPositions);
            }
            else{
                _areaDataManager.AddPositinToCurrentAreaDatas(_userName,newPos);
            }
        }
    }
}
